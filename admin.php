...
// เรียกใช้ไฟล์ config/db.php ที่เก็บการตั้งค่าฐานข้อมูล
...
if (isset($_GET['logout'])) {
  // กรณีมีการส่งพารามิเตอร์ 'logout' มา
  header('location: signin.php');
  exit(); // สิ้นสุดการทำงาน

  // ลบ Session ของ Admin หากมีการล็อกเอาท์
    ...
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li class="dropdown">
            <a href="#"><span>Profile</span> <i class="bi bi-chevron-down  edit-icon"></i></a>
            <ul>
              ...
              <?php if (isset($_SESSION['admin_login'])):
                ...
                <li>
                  <h2 class="user-position">
                    <?php echo 'ตำแหน่ง: Admin' ?>
                  </h2>
                </li>
              <?php else: ?>
                <!-- ถ้าไม่ได้เข้าสู่ระบบเป็น admin ไม่ต้องแสดงอะไร -->
              <?php endif; ?>
            </ul>
          </li>
      ...
      <div class="row gy-4 mt-5 justify-content-center">
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
            ...
            <h3><a href="user_list.php">รายชื่อผู้ใช้น้ำ</a></h3>
          </div>
        </div>
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
            ...
            <h3><a href="adduser.php">เพิ่มรายชื่อผู้ใช้น้ำประปา</a></h3>
          </div>
        </div>
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
            <a href="waterusage.php">
              <i class="bi bi-pencil"></i>
            </a>
            <h3><a href="waterusage.php">บันทึกมิเตอร์</a></h3>
          </div>
        </div>
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
            <a href="user_payment_status.php">
              <i class="bi bi-file-text"></i>
            </a>
            <h3><a href="user_payment_status.php"> ตรวจสอบการชำระ</a></h3>
          </div>
        </div>
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
            ...
            <h3><a href="problem.php">ตรวจสอบการแจ้งปัญหา</a></h3>
          </div>
        </div>
      </div>
